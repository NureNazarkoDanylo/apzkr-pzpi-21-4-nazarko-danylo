...
public class UpdateWashingMachineCommandValidator : AbstractValidator<UpdateWashingMachineCommand>
{
    private readonly IJsonStringLocalizer _localizer;

    public UpdateWashingMachineCommandValidator(IJsonStringLocalizer localizer)
    {
